...
class _FomrularioAlumnoState extends State<FomrularioAlumno> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const FormularioAlumnoTextfield(),
    );
  }
}
...
class FormularioAlumnoTextfield extends StatefulWidget {
  const FormularioAlumnoTextfield({super.key});
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  RegExp nombreAlumno = RegExp(r'^[a-zA-ZáéíóúüÁÉÍÓÚÜñÑ\s]+$');
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  RegExp apellidoMaterno = RegExp(r'^[a-zA-ZáéíóúüÁÉÍÓÚÜñÑ\s]+$');
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  RegExp nombreTutor = RegExp(r'^[a-zA-ZáéíóúüÁÉÍÓÚÜñÑ\s]+$');
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  RegExp apPTutor = new RegExp(r'^[a-zA-ZáéíóúüÁÉÍÓÚÜñÑ\s]+$');
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  RegExp apMTutor = new RegExp(r'^[a-zA-ZáéíóúüÁÉÍÓÚÜñÑ\s]+$');
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  RegExp telefonoPrincipal =
                                      RegExp(r'^[0-9]{10}$');
                                  RegExp letraTelefono = RegExp(r'^[a-zA-ZáéíóúüÁÉÍÓÚÜñÑ\s]+$');
